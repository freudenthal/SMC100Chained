...
class SMC100Chained
{
	...
	private:
		...
		static const uint8_t ErrorCountMaxLimit;
		...
		FinishedListener ErrorBackupCompleteCallback;
		bool CurrentCommandCompleteCallbackFired;
		bool ErrorBackupCompleteCallbackFired;
		...
		const CommandStruct* ErrorBackupCommand;
		CommandGetSetType CurrentCommandGetOrSet;
		CommandGetSetType ErrorBackupGetOrSet;
		float CurrentCommandParameter;
		float ErrorBackupParameter;
		uint8_t CurrentCommandAddress;
		uint8_t ErrorBackupAddress;
		uint8_t CurrentCommandMotorIndex;
		uint8_t ErrorBackupMotorIndex;
		uint8_t ErrorCount;
